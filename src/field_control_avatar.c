...
static void UNUSED GetInFrontOfPlayerPosition(struct MapPosition *); // Replaced by below
...
static void UNUSED GetInFrontOfPlayerPosition(struct MapPosition *position)
{
    s16 x, y;
