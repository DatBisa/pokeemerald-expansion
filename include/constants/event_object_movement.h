...
#define MOVEMENT_ACTION_FACE_SOUTHWEST                  0xA0
#define MOVEMENT_ACTION_FACE_SOUTHEAST                  0xA1
#define MOVEMENT_ACTION_FACE_NORTHWEST                  0xA2
#define MOVEMENT_ACTION_FACE_NORTHEAST                  0xA3
#define MOVEMENT_ACTION_JUMP_2_SOUTHWEST                0xA4
#define MOVEMENT_ACTION_JUMP_2_SOUTHEAST                0xA5
#define MOVEMENT_ACTION_JUMP_2_NORTHWEST                0xA6
#define MOVEMENT_ACTION_JUMP_2_NORTHEAST                0xA7
#define MOVEMENT_ACTION_WALK_FAST_SOUTHWEST             0xA8
#define MOVEMENT_ACTION_WALK_FAST_SOUTHEAST             0xA9
#define MOVEMENT_ACTION_WALK_FAST_NORTHWEST             0xAA
#define MOVEMENT_ACTION_WALK_FAST_NORTHEAST             0xAB
#define MOVEMENT_ACTION_WALK_IN_PLACE_SLOW_SOUTHWEST    0xAC
#define MOVEMENT_ACTION_WALK_IN_PLACE_SLOW_SOUTHEAST    0xAD
#define MOVEMENT_ACTION_WALK_IN_PLACE_SLOW_NORTHWEST    0xAE
#define MOVEMENT_ACTION_WALK_IN_PLACE_SLOW_NORTHEAST    0xAF
#define MOVEMENT_ACTION_WALK_IN_PLACE_NORMAL_SOUTHWEST  0xB0
#define MOVEMENT_ACTION_WALK_IN_PLACE_NORMAL_SOUTHEAST  0xB1
#define MOVEMENT_ACTION_WALK_IN_PLACE_NORMAL_NORTHWEST  0xB2
#define MOVEMENT_ACTION_WALK_IN_PLACE_NORMAL_NORTHEAST  0xB3
#define MOVEMENT_ACTION_WALK_IN_PLACE_FAST_SOUTHWEST    0xB4
#define MOVEMENT_ACTION_WALK_IN_PLACE_FAST_SOUTHEAST    0xB5
#define MOVEMENT_ACTION_WALK_IN_PLACE_FAST_NORTHWEST    0xB6
#define MOVEMENT_ACTION_WALK_IN_PLACE_FAST_NORTHEAST    0xB7
#define MOVEMENT_ACTION_WALK_IN_PLACE_FASTEST_SOUTHWEST 0xB8
#define MOVEMENT_ACTION_WALK_IN_PLACE_FASTEST_SOUTHEAST 0xB9
#define MOVEMENT_ACTION_WALK_IN_PLACE_FASTEST_NORTHWEST 0xBA
#define MOVEMENT_ACTION_WALK_IN_PLACE_FASTEST_NORTHEAST 0xBB
#define MOVEMENT_ACTION_WALK_FASTEST_SOUTHWEST          0xBC
#define MOVEMENT_ACTION_WALK_FASTEST_SOUTHEAST          0xBD
#define MOVEMENT_ACTION_WALK_FASTEST_NORTHWEST          0xBE
#define MOVEMENT_ACTION_WALK_FASTEST_NORTHEAST          0xBF
#define MOVEMENT_ACTION_PLAYER_RUN_SOUTHWEST            0xC0
#define MOVEMENT_ACTION_PLAYER_RUN_SOUTHEAST            0xC1
#define MOVEMENT_ACTION_PLAYER_RUN_NORTHWEST            0xC2
#define MOVEMENT_ACTION_PLAYER_RUN_NORTHEAST            0xC3
