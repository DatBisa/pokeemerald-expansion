...
#define MOVEMENT_ACTION_WALK_NORMAL_NORTHWEST           0x8C
#define MOVEMENT_ACTION_WALK_NORMAL_NORTHEAST           0x8D
#define MOVEMENT_ACTION_WALK_NORMAL_SOUTHWEST           0x8E
#define MOVEMENT_ACTION_WALK_NORMAL_SOUTHEAST           0x8F
#define MOVEMENT_ACTION_WALK_SLOW_NORTHWEST             0x90
#define MOVEMENT_ACTION_WALK_SLOW_NORTHEAST             0x91
#define MOVEMENT_ACTION_WALK_SLOW_SOUTHWEST             0x92
#define MOVEMENT_ACTION_WALK_SLOW_SOUTHEAST             0x93
...
#define MOVEMENT_ACTION_FACE_SOUTHWEST                  0x9E
#define MOVEMENT_ACTION_FACE_SOUTHEAST                  0x9F
#define MOVEMENT_ACTION_FACE_NORTHWEST                  0xA0
#define MOVEMENT_ACTION_FACE_NORTHEAST                  0xA1
#define MOVEMENT_ACTION_JUMP_2_SOUTHWEST                0xA2
#define MOVEMENT_ACTION_JUMP_2_SOUTHEAST                0xA3
#define MOVEMENT_ACTION_JUMP_2_NORTHWEST                0xA4
#define MOVEMENT_ACTION_JUMP_2_NORTHEAST                0xA5
#define MOVEMENT_ACTION_WALK_FAST_SOUTHWEST             0xA6
#define MOVEMENT_ACTION_WALK_FAST_SOUTHEAST             0xA7
#define MOVEMENT_ACTION_WALK_FAST_NORTHWEST             0xA8
#define MOVEMENT_ACTION_WALK_FAST_NORTHEAST             0xA9
#define MOVEMENT_ACTION_WALK_IN_PLACE_SLOW_SOUTHWEST    0xAA
#define MOVEMENT_ACTION_WALK_IN_PLACE_SLOW_SOUTHEAST    0xAB
#define MOVEMENT_ACTION_WALK_IN_PLACE_SLOW_NORTHWEST    0xAC
#define MOVEMENT_ACTION_WALK_IN_PLACE_SLOW_NORTHEAST    0xAD
#define MOVEMENT_ACTION_WALK_IN_PLACE_NORMAL_SOUTHWEST  0xAE
#define MOVEMENT_ACTION_WALK_IN_PLACE_NORMAL_SOUTHEAST  0xAF
#define MOVEMENT_ACTION_WALK_IN_PLACE_NORMAL_NORTHWEST  0xB0
#define MOVEMENT_ACTION_WALK_IN_PLACE_NORMAL_NORTHEAST  0xB1
#define MOVEMENT_ACTION_WALK_IN_PLACE_FAST_SOUTHWEST    0xB2
#define MOVEMENT_ACTION_WALK_IN_PLACE_FAST_SOUTHEAST    0xB3
#define MOVEMENT_ACTION_WALK_IN_PLACE_FAST_NORTHWEST    0xB4
#define MOVEMENT_ACTION_WALK_IN_PLACE_FAST_NORTHEAST    0xB5
#define MOVEMENT_ACTION_WALK_IN_PLACE_FASTEST_SOUTHWEST 0xB6
#define MOVEMENT_ACTION_WALK_IN_PLACE_FASTEST_SOUTHEAST 0xB7
#define MOVEMENT_ACTION_WALK_IN_PLACE_FASTEST_NORTHWEST 0xB8
#define MOVEMENT_ACTION_WALK_IN_PLACE_FASTEST_NORTHEAST 0xB9
#define MOVEMENT_ACTION_WALK_FASTEST_SOUTHWEST          0xBA
#define MOVEMENT_ACTION_WALK_FASTEST_SOUTHEAST          0xBB
#define MOVEMENT_ACTION_WALK_FASTEST_NORTHWEST          0xBC
#define MOVEMENT_ACTION_WALK_FASTEST_NORTHEAST          0xBD
#define MOVEMENT_ACTION_PLAYER_RUN_SOUTHWEST            0xBE
#define MOVEMENT_ACTION_PLAYER_RUN_SOUTHEAST            0xBF
#define MOVEMENT_ACTION_PLAYER_RUN_NORTHWEST            0xC0
#define MOVEMENT_ACTION_PLAYER_RUN_NORTHEAST            0xC1
#define MOVEMENT_ACTION_RIDE_WATER_CURRENT_SOUTHWEST    0xC2
#define MOVEMENT_ACTION_RIDE_WATER_CURRENT_SOUTHEAST    0xC3
#define MOVEMENT_ACTION_RIDE_WATER_CURRENT_NORTHWEST    0xC4
#define MOVEMENT_ACTION_RIDE_WATER_CURRENT_NORTHEAST    0xC5
#define MOVEMENT_ACTION_JUMP_SOUTHWEST                  0xC6
#define MOVEMENT_ACTION_JUMP_SOUTHEAST                  0xC7
#define MOVEMENT_ACTION_JUMP_NORTHWEST                  0xC8
#define MOVEMENT_ACTION_JUMP_NORTHEAST                  0xC9
#define MOVEMENT_ACTION_JUMP_IN_PLACE_SOUTHWEST         0xCA
#define MOVEMENT_ACTION_JUMP_IN_PLACE_SOUTHEAST         0xCB
#define MOVEMENT_ACTION_JUMP_IN_PLACE_NORTHWEST         0xCC
#define MOVEMENT_ACTION_JUMP_IN_PLACE_NORTHEAST         0xCD
#define MOVEMENT_ACTION_JUMP_IN_PLACE_SOUTHWEST_NORTHEAST 0xCE
#define MOVEMENT_ACTION_JUMP_IN_PLACE_SOUTHEAST_NORTHWEST 0xCF
#define MOVEMENT_ACTION_JUMP_IN_PLACE_NORTHWEST_SOUTHEAST 0xD0
#define MOVEMENT_ACTION_JUMP_IN_PLACE_NORTHEAST_SOUTHWEST 0xD1
#define MOVEMENT_ACTION_JUMP_SPECIAL_SOUTHWEST          0xD2
#define MOVEMENT_ACTION_JUMP_SPECIAL_SOUTHEAST          0xD3
#define MOVEMENT_ACTION_JUMP_SPECIAL_NORTHWEST          0xD4
#define MOVEMENT_ACTION_JUMP_SPECIAL_NORTHEAST          0xD5
#define MOVEMENT_ACTION_ACRO_WHEELIE_FACE_SOUTHWEST     0xD6
#define MOVEMENT_ACTION_ACRO_WHEELIE_FACE_SOUTHEAST     0xD7
#define MOVEMENT_ACTION_ACRO_WHEELIE_FACE_NORTHWEST     0xD8
#define MOVEMENT_ACTION_ACRO_WHEELIE_FACE_NORTHEAST     0xD9
#define MOVEMENT_ACTION_ACRO_POP_WHEELIE_SOUTHWEST      0xDA
#define MOVEMENT_ACTION_ACRO_POP_WHEELIE_SOUTHEAST      0xDB
#define MOVEMENT_ACTION_ACRO_POP_WHEELIE_NORTHWEST      0xDC
#define MOVEMENT_ACTION_ACRO_POP_WHEELIE_NORTHEAST      0xDD
#define MOVEMENT_ACTION_ACRO_END_WHEELIE_FACE_SOUTHWEST 0xDE
#define MOVEMENT_ACTION_ACRO_END_WHEELIE_FACE_SOUTHEAST 0xDF
#define MOVEMENT_ACTION_ACRO_END_WHEELIE_FACE_NORTHWEST 0xE0
#define MOVEMENT_ACTION_ACRO_END_WHEELIE_FACE_NORTHEAST 0xE1
#define MOVEMENT_ACTION_ACRO_WHEELIE_HOP_FACE_SOUTHWEST 0xE2
#define MOVEMENT_ACTION_ACRO_WHEELIE_HOP_FACE_SOUTHEAST 0xE3
#define MOVEMENT_ACTION_ACRO_WHEELIE_HOP_FACE_NORTHWEST 0xE4
#define MOVEMENT_ACTION_ACRO_WHEELIE_HOP_FACE_NORTHEAST 0xE5
#define MOVEMENT_ACTION_ACRO_WHEELIE_HOP_SOUTHWEST      0xE6
#define MOVEMENT_ACTION_ACRO_WHEELIE_HOP_SOUTHEAST      0xE7
#define MOVEMENT_ACTION_ACRO_WHEELIE_HOP_NORTHWEST      0xE8
#define MOVEMENT_ACTION_ACRO_WHEELIE_HOP_NORTHEAST      0xE9
#define MOVEMENT_ACTION_ACRO_WHEELIE_JUMP_SOUTHWEST     0xEA
#define MOVEMENT_ACTION_ACRO_WHEELIE_JUMP_SOUTHEAST     0xEB
#define MOVEMENT_ACTION_ACRO_WHEELIE_JUMP_NORTHWEST     0xEC
#define MOVEMENT_ACTION_ACRO_WHEELIE_JUMP_NORTHEAST     0xED
#define MOVEMENT_ACTION_ACRO_WHEELIE_IN_PLACE_SOUTHWEST 0xEE
#define MOVEMENT_ACTION_ACRO_WHEELIE_IN_PLACE_SOUTHEAST 0xEF
#define MOVEMENT_ACTION_ACRO_WHEELIE_IN_PLACE_NORTHWEST 0xF0
#define MOVEMENT_ACTION_ACRO_WHEELIE_IN_PLACE_NORTHEAST 0xF1
#define MOVEMENT_ACTION_ACRO_POP_WHEELIE_MOVE_SOUTHWEST 0xF2
#define MOVEMENT_ACTION_ACRO_POP_WHEELIE_MOVE_SOUTHEAST 0xF3
#define MOVEMENT_ACTION_ACRO_POP_WHEELIE_MOVE_NORTHWEST 0xF4
#define MOVEMENT_ACTION_ACRO_POP_WHEELIE_MOVE_NORTHEAST 0xF5
#define MOVEMENT_ACTION_ACRO_WHEELIE_MOVE_SOUTHWEST     0xF6
#define MOVEMENT_ACTION_ACRO_WHEELIE_MOVE_SOUTHEAST     0xF7
#define MOVEMENT_ACTION_ACRO_WHEELIE_MOVE_NORTHWEST     0xF8
#define MOVEMENT_ACTION_ACRO_WHEELIE_MOVE_NORTHEAST     0xF9
#define MOVEMENT_ACTION_ACRO_END_WHEELIE_MOVE_SOUTHWEST 0xFA
...
#define ANIM_STD_FACE_SOUTHWEST       20
#define ANIM_STD_FACE_SOUTHEAST       21
#define ANIM_STD_FACE_NORTHWEST       22
#define ANIM_STD_FACE_NORTHEAST       23
#define ANIM_STD_GO_SOUTHWEST         24
#define ANIM_STD_GO_SOUTHEAST         25
#define ANIM_STD_GO_NORTHWEST         26
#define ANIM_STD_GO_NORTHEAST         27
#define ANIM_STD_GO_FAST_SOUTHWEST    28
#define ANIM_STD_GO_FAST_SOUTHEAST    29
#define ANIM_STD_GO_FAST_NORTHWEST    30
#define ANIM_STD_GO_FAST_NORTHEAST    31
#define ANIM_STD_GO_FASTER_SOUTHWEST  32
#define ANIM_STD_GO_FASTER_SOUTHEAST  33
#define ANIM_STD_GO_FASTER_NORTHWEST  34
#define ANIM_STD_GO_FASTER_NORTHEAST  35
#define ANIM_STD_GO_FASTEST_SOUTHWEST 36
#define ANIM_STD_GO_FASTEST_SOUTHEAST 37
#define ANIM_STD_GO_FASTEST_NORTHWEST 38
#define ANIM_STD_GO_FASTEST_NORTHEAST 39
#define ANIM_STD_COUNT                40
...
#define ANIM_RUN_SOUTHWEST (ANIM_STD_COUNT + 4)
#define ANIM_RUN_SOUTHEAST (ANIM_STD_COUNT + 5)
#define ANIM_RUN_NORTHWEST (ANIM_STD_COUNT + 6)
#define ANIM_RUN_NORTHEAST (ANIM_STD_COUNT + 7)
...
#define ANIM_BUNNY_HOP_BACK_WHEEL_SOUTHWEST      (ANIM_STD_COUNT + 20)
#define ANIM_BUNNY_HOP_BACK_WHEEL_SOUTHEAST      (ANIM_STD_COUNT + 21)
#define ANIM_BUNNY_HOP_BACK_WHEEL_NORTHWEST      (ANIM_STD_COUNT + 22)
#define ANIM_BUNNY_HOP_BACK_WHEEL_NORTHEAST      (ANIM_STD_COUNT + 23)
#define ANIM_STANDING_WHEELIE_BACK_WHEEL_SOUTHWEST (ANIM_STD_COUNT + 24)
#define ANIM_STANDING_WHEELIE_BACK_WHEEL_SOUTHEAST (ANIM_STD_COUNT + 25)
#define ANIM_STANDING_WHEELIE_BACK_WHEEL_NORTHWEST (ANIM_STD_COUNT + 26)
#define ANIM_STANDING_WHEELIE_BACK_WHEEL_NORTHEAST (ANIM_STD_COUNT + 27)
#define ANIM_MOVING_WHEELIE_SOUTHWEST              (ANIM_STD_COUNT + 28)
#define ANIM_MOVING_WHEELIE_SOUTHEAST              (ANIM_STD_COUNT + 29)
#define ANIM_MOVING_WHEELIE_NORTHWEST              (ANIM_STD_COUNT + 30)
#define ANIM_MOVING_WHEELIE_NORTHEAST              (ANIM_STD_COUNT + 31)
...
#define ANIM_GET_ON_OFF_POKEMON_SOUTHWEST          (ANIM_STD_COUNT + 4)
#define ANIM_GET_ON_OFF_POKEMON_SOUTHEAST          (ANIM_STD_COUNT + 5)
#define ANIM_GET_ON_OFF_POKEMON_NORTHWEST          (ANIM_STD_COUNT + 6)
#define ANIM_GET_ON_OFF_POKEMON_NORTHEAST          (ANIM_STD_COUNT + 7)
...
#define ANIM_TAKE_OUT_ROD_SOUTHWEST   12
#define ANIM_TAKE_OUT_ROD_SOUTHEAST   13
#define ANIM_TAKE_OUT_ROD_NORTHEAST   14
#define ANIM_TAKE_OUT_ROD_NORTHWEST   15
#define ANIM_PUT_AWAY_ROD_SOUTHWEST   16
#define ANIM_PUT_AWAY_ROD_SOUTHEAST   17
#define ANIM_PUT_AWAY_ROD_NORTHEAST   18
#define ANIM_PUT_AWAY_ROD_NORTHWEST   19
#define ANIM_HOOKED_POKEMON_SOUTHWEST 20
#define ANIM_HOOKED_POKEMON_SOUTHEAST 21
#define ANIM_HOOKED_POKEMON_NORTHEAST 22
#define ANIM_HOOKED_POKEMON_NORTHWEST 23
