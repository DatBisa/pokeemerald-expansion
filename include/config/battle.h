...
#define B_RECALC_TURN_AFTER_ACTIONS GEN_7 // In Gen8, switching/using a move affects the current turn's order of actions.
...
#define B_SYNCHRONIZE_NATURE        GEN_7 // In Gen8, if a Pokémon with Synchronize is leading the party, it's 100% guaranteed that wild Pokémon will have the same Nature, as opposed to 50% previously.
...
#define B_OVERWORLD_SNOW                GEN_7 // In Gen9+, overworld Snow will summon snow instead of hail.
